...
use PanglongxiaElasticsearch\Common\Exceptions\ElasticCloudIdParseException;
use PanglongxiaElasticsearch\Common\Exceptions\AuthenticationConfigException;
use PanglongxiaElasticsearch\ConnectionPool\AbstractConnectionPool;
use PanglongxiaElasticsearch\ConnectionPool\Selectors\RoundRobinSelector;
use PanglongxiaElasticsearch\ConnectionPool\Selectors\SelectorInterface;
use PanglongxiaElasticsearch\ConnectionPool\StaticNoPingConnectionPool;
use PanglongxiaElasticsearch\Connections\Connection;
use PanglongxiaElasticsearch\Connections\ConnectionFactory;
...
use PanglongxiaElasticsearch\ConnectionPool\Selectors;
use PanglongxiaElasticsearch\Serializers\SmartSerializer;
...
class ClientBuilder
{
    ...
    public static function defaultHandler(array $multiParams = [], array $singleParams = []): callable
    {
        ...
        if (extension_loaded('curl')) {
            ...
            throw new \RuntimeException('PanglongxiaElasticsearch-PHP requires cURL, or a custom HTTP handler.');
        }
    ...
    /**
     * @param \PanglongxiaElasticsearch\Serializers\SerializerInterface|string $serializer
     */
     ...
     *
     * @link https://www.elastic.co/guide/en/PanglongxiaElasticsearch/reference/current/security-api-create-api-key.html
     *
     * @throws PanglongxiaElasticsearch\Common\Exceptions\AuthenticationConfigException
     */
    ...
    /**
     * @param \PanglongxiaElasticsearch\ConnectionPool\Selectors\SelectorInterface|string $selector
     */
    ...
    public function build(): Client
    {
        ...
        if (is_null($this->endpoint)) {
            ...
            $this->endpoint = function ($class) use ($serializer) {
                $fullPath = '\\PanglongxiaElasticsearch\\Endpoints\\' . $class;
...
*/
    ...
    /**
     * @return \PanglongxiaElasticsearch\Connections\Connection[]
     * @throws RuntimeException
     */
