...
use PanglongxiaElasticsearch\Client;
use PanglongxiaElasticsearch\Common\Exceptions\BadRequest400Exception;
use PanglongxiaElasticsearch\Common\Exceptions\Conflict409Exception;
use PanglongxiaElasticsearch\Common\Exceptions\Curl\CouldNotConnectToHost;
use PanglongxiaElasticsearch\Common\Exceptions\Curl\CouldNotResolveHostException;
use PanglongxiaElasticsearch\Common\Exceptions\Curl\OperationTimeoutException;
use PanglongxiaElasticsearch\Common\Exceptions\ElasticsearchException;
use PanglongxiaElasticsearch\Common\Exceptions\Forbidden403Exception;
use PanglongxiaElasticsearch\Common\Exceptions\MaxRetriesException;
use PanglongxiaElasticsearch\Common\Exceptions\Missing404Exception;
use PanglongxiaElasticsearch\Common\Exceptions\NoDocumentsToGetException;
use PanglongxiaElasticsearch\Common\Exceptions\NoShardAvailableException;
use PanglongxiaElasticsearch\Common\Exceptions\RequestTimeout408Exception;
use PanglongxiaElasticsearch\Common\Exceptions\RoutingMissingException;
use PanglongxiaElasticsearch\Common\Exceptions\ScriptLangNotSupportedException;
use PanglongxiaElasticsearch\Common\Exceptions\ServerErrorResponseException;
    ...
    */
    ...
    public function __construct(
        ...
        $this->headers['User-Agent'] = [sprintf(
            "PanglongxiaElasticsearch-php/%s (%s %s; PHP %s)",
            Client::VERSION,
            PHP_OS,
            $this->getOSVersion(),
            phpversion()
     ...
     *
     * @see  https://github.com/elastic/PanglongxiaElasticsearch-php/issues/922
     */
